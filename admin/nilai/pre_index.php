    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="a" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        include '../helper/index_jadwal_pelajaran_admin.php';
                        // echo $hari;die();
                        if($cekjw > 0) :
                            ...
                            include '../helper/index_pelajaran_kelas_admin.php';
                            if($cekj > 0) :
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="?page=nilai-index" method="post">
                                <input type="hidden" name="pelajaran_id" value="<?= $keyj['id_pelajaran'] ?>">
                                ...
                                <button name="submit" type="submit" class="btn btn-success">buka nilai</button>
                            </form>
                        </td>
                    </tr>
                    <?php 

...
//update
$result=mysqli_query($conn, "UPDATE `jadwal_pelajaran` SET `thn_akademik_id`='$thn_akademik_id', `kelas_id`='$kelas_id', `pelajaran_id`='$pelajaran_id', `hari_id`='$hari_id', `jam_mulai`='$jam_mulai', `jam_selesai`='$jam_selesai', `ruangan`='$ruangan' WHERE `id_jdwl_pelajaran`=$id_jdwl_pelajaran");

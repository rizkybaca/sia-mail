...
//insert
$result=mysqli_query($conn, "INSERT INTO `jadwal_pelajaran` (`thn_akademik_id`, `kelas_id`, `pelajaran_kode`, `hari_id`, `jam_mulai`, `jam_selesai`, `ruangan`) VALUES ('$thn_akademik_id', '$kelas_id', '$pelajaran_kode', '$hari_id', '$jam_mulai', '$jam_selesai', '$ruangan')");

...
//insert
$result=mysqli_query($conn, "INSERT INTO `detail_rombel` (`rombel_id`,`siswa_id`,`kelas_id`,`kurikulum_id`,`thn_akademik_id`) VALUES ('$rombel_id','$siswa_id','$kelas_id','$kurikulum_id','$thn_akademik_id')");
// var_dump($_POST);die();

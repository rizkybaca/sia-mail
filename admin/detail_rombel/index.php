            ...
            <table class="table table-bordered" id="a" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="?page=detail_rombel-edit&id_detail_rombel=<?= $key['id_dtl_rombel'] ?>" class="badge badge-warning">edit</a>
                            <a href="detail_rombel/delete.php?id_detail_rombel=<?= $key['id_dtl_rombel'] ?>&id_rombel=<?= $val['id_rombel'] ?>" class="badge badge-danger" onclick="return confirm('are you sure?');" >hapus</a>
                        </td>
                    </tr>
                    <?php 
                        endwhile;

...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="sistem/update.php" enctype="multipart/form-data">
                <input type="hidden" name="id_sistem" value="<?= $key['id_sistem'] ?>">
                <div class="form-group">
                    <label for="nama_sistem">nama_sistem</label>
                    <input required  name="nama_sistem" type="text" class="form-control" id="nama_sistem" placeholder="masukkan nama_sistem sistem" value="<?= $key['nama_sistem'] ?>">
                </div>
                <div class="form-group">
                    <label for="versi">versi</label>
                    <textarea required name="versi" class="form-control" id="versi" rows="3" placeholder="masukkan versi sistem" ><?= $key['versi'] ?></textarea>
                </div>
                <div class="form-group">
                    <label for="pengembang">pengembang</label>
                    <textarea required name="pengembang" class="form-control" id="pengembang" rows="3" placeholder="masukkan pengembang sistem" ><?= $key['pengembang'] ?></textarea>
                </div>
                <!-- sementara logo sistem manual 1280 × 720 px -->
                <img src="../img/logo_sistem.png">
                
                <div class="form-group">
                    <label for="logo_sistem">pilih logo sistem</label>
                    <input type="file" class="form-control-file" id="logo_sistem">
                </div>

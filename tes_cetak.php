        ...
        *{
        ...
        @media print {
            * {
                ...
                forced-color-adjust: exact !important; /*edge*/
            }
        }
    </style>
</head>
...
<!-- <img src="img/img/kpel.png" alt="Graph Description" /> -->
    ...
    <img style="position: absolute;padding-left: 12px;padding-top: 5px;" class="img-responsive img" alt="Responsive image" src="img/img/daerah.png" width="40px">
    <img style="position: absolute;padding-left: 312px;padding-top: 5px;" class="img-responsive img" alt="Responsive image" src="img/img/twh.png" width="50px">
    <p style="position: absolute; font-family: arial; font-size: 10px; color: #fff; padding-left: 85px;text-transform: uppercase; text-align: center;"> Pemerintah Provinsi Papua<br>Kabupaten Nabire<br>Dinas Pendidikan<br><b style="font-size: 12px">SMK AL-MADINA NABIRE</b></p>
    <p style="padding-left: 123px;padding-top: 70px; "><b>KARTU PELAJAR</b></p>
    <img style="border: 1px solid #ffffff;position: absolute;margin-left: 20px;margin-top: -20px;" src="img/img/blank.png" width="80px">
        ...
        <p style="padding-left: 10px;font-size: 8px; font-family: arial;position: absolute;">Alamat: Jl. Ksatrian, Desa Girimulyo Kec. Nabire - Kode Pos 98851<br> Email: smk@mail.com | Telp. 0880 | Website: smk-almadina.com</p>
...
<ol style="padding-left: 400px;color: #FFFFFF; font-family: arial;font-size: 11px;text-align: justify;padding-right: 10px">
        ...
        <img style="position: absolute;padding-left: 530px;padding-top: 5px;" class="img-responsive img" alt="Responsive image" src="img/img/ttd_kepsek.png" width="70px">
        <?php
            // $s=mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM stempel WHERE id = '1'"));
        ?><br><img style="position: absolute;padding-left: 530px;margin-top: -20px;" class="img-responsive img" alt="Responsive image" src="img/img/Stempel2.png" width="50px">
        <p style="position: absolute;padding-left: 550px;margin-top: 20px;font-size: 10px; font-family: arial;"><b><u>Suprapto, M.Pd.</u></b><br>NIP. 100112</p>
</div>

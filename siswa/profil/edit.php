...
if(!isset($_SESSION['id_guru'])){
    ...
    include_once '../helper/show_profil.php';
        ...
        <div class="card-body">
            <form method="POST" action="profil/update.php">
                ...
                <div class="form-group">
                    ...
                    <input required name="telepon" type="text" class="form-control" id="telepon" placeholder="masukkan telepon guru" value="<?= $key['telepon'] ?>">
                </div>
                <br>

...
?>
        ...
        <a href="?page=password-edit" class="btn btn-outline-success">Edit Password</a>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="" action="">
                        <!-- <input type="hidden" name="id_siswa" value="<?php $key['id_siswa'] ?>"> -->
                        ...
                        <div class="form-group">
                            ...
                            <textarea readonly name="alamat" class="form-control" id="alamat" rows="3" placeholder="masukkan alamat siswa"><?= $key['alamat'] ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="telepon">Telepon</label>
                            <input readonly name="telepon" type="text" class="form-control" id="telepon" placeholder="masukkan telepon siswa" value="<?= $key['telepon'] ?>">
                        </div>
                        <br>
